    ...
    filled: (
      <g>
        <g id="LayoutIcon/Fill/layout">
          ...
          />
          <mask id="Layoutmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="18" height="18">
            <path
              id="LayoutMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Layout-oIcon/Outline/layout">
          ...
          />
          <mask id="Layout-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="18" height="18">
            <path
              id="Layout-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
