    ...
    filled: (
      <g>
        <g id="PrinterIcon/Fill/printer">
          ...
          />
          <mask id="Printermask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="PrinterMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Printer-oIcon/Outline/printer">
          ...
          />
          <mask id="Printer-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="Printer-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
