    ...
    filled: (
      <g>
        <g id="FolderIcon/Fill/folder">
          ...
          />
          <mask id="Foldermask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="FolderMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Folder-oIcon/Outline/folder">
          ...
          />
          <mask id="Folder-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="Folder-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
