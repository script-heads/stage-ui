    ...
    filled: (
      <g>
        <g id="BriefcaseIcon/Fill/briefcase">
          ...
          />
          <mask id="Briefcasemask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="BriefcaseMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Briefcase-oIcon/Outline/briefcase">
          ...
          />
          <mask id="Briefcase-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
