    ...
    filled: (
      <g>
        <g id="MenuIcon/Fill/menu">
          ...
          />
          <mask id="Menumask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="6" width="19" height="12">
            <path
              id="MenuMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Menu-oIcon/Outline/menu">
          ...
          />
          <mask id="Menu-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="6" width="19" height="12">
            <path
              id="Menu-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
