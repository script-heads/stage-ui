    ...
    filled: (
      <g>
        <g id="PersonDoneIcon/Fill/person-done">
          ...
          />
          <mask id="PersonDonemask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="20" height="18">
            <path
              id="PersonDoneMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="PersonDone-oIcon/Outline/person-done">
          ...
          />
          <mask id="PersonDone-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="20" height="18">
            <path
