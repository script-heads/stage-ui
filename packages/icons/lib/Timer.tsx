...
export default React.forwardRef((props: Props, ref: React.ForwardedRef<HTMLSpanElement>) =>
  createIcon(props, ref, {
    filled: (
      <g>
        <g id="TimerIcon/Fill/timer">
          ...
          <g mask="url(#Timermask0)">
            <g id="Timer&#Timer240;&#Timer159;&#Timer142;&#Timer168; Color">
              <rect id="TimerBase" width="24" height="24" />
            </g>
          </g>
        </g>
      </g>
    ...
    outline: (
      <g>
        <g id="Timer-oIcon/Outline/timer">
          <path
            id="Timer-oMask"
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <g mask="url(#Timer-omask0)">
            <g id="Timer-o&#Timer-o240;&#Timer-o159;&#Timer-o142;&#Timer-o168; Color">
              <rect id="Timer-oBase" width="24" height="24" />
            </g>
          </g>
        </g>
      </g>
