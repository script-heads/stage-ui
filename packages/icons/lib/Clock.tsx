...
export default React.forwardRef((props: Props, ref: React.ForwardedRef<HTMLSpanElement>) =>
  createIcon(props, ref, {
    filled: (
      <g>
        <g id="ClockIcon/Fill/clock">
          ...
          <g mask="url(#Clockmask0)">
            <g id="Clock&#Clock240;&#Clock159;&#Clock142;&#Clock168; Color">
              <rect id="ClockBase" width="24" height="24" />
            </g>
          </g>
        </g>
      </g>
    ...
    outline: (
      <g>
        <g id="Clock-oIcon/Outline/clock">
          <path
            id="Clock-oMask"
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <g mask="url(#Clock-omask0)">
            <g id="Clock-o&#Clock-o240;&#Clock-o159;&#Clock-o142;&#Clock-o168; Color">
              <rect id="Clock-oBase" width="24" height="24" />
            </g>
          </g>
        </g>
      </g>
