    ...
    filled: (
      <g>
        <g id="SkipForwardIcon/Fill/skip-forward">
          ...
          />
          <mask id="SkipForwardmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="6" y="5" width="11" height="14">
            <path
    ...
    outline: (
      <g>
        <g id="SkipForward-oIcon/Outline/skip-forward">
          ...
          />
          <mask id="SkipForward-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="6" y="5" width="11" height="14">
            <path
