    ...
    filled: (
      <g>
        <g id="SaveIcon/Fill/save">
          ...
          />
          <mask id="Savemask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="19" height="18">
            <path
              id="SaveMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Save-oIcon/Outline/save">
          ...
          />
          <mask id="Save-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="18" height="18">
            <path
              id="Save-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
