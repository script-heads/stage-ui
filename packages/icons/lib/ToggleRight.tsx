    ...
    filled: (
      <g>
        <g id="ToggleRightIcon/Fill/toggle-right">
          ...
          />
          <mask id="ToggleRightmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="5" width="20" height="14">
            <path
    ...
    outline: (
      <g>
        <g id="ToggleRight-oIcon/Outline/toggle-right">
          ...
          />
          <mask id="ToggleRight-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="5" width="20" height="14">
            <path
