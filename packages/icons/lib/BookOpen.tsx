    ...
    filled: (
      <g>
        <g id="BookOpenIcon/Fill/book-open">
          ...
          />
          <mask id="BookOpenmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="4" width="20" height="17">
            <path
              id="BookOpenMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="BookOpen-oIcon/Outline/book-open">
          ...
          />
          <mask id="BookOpen-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="3" width="18" height="18">
            <path
              id="BookOpen-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
