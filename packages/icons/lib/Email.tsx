    ...
    filled: (
      <g>
        <g id="EmailIcon/Fill/email">
          ...
          />
          <mask id="Emailmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="4" width="21" height="16">
            <path
              id="EmailMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Email-oIcon/Outline/email">
          ...
          />
          <mask id="Email-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="4" width="20" height="16">
            <path
              id="Email-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
