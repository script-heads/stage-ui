    ...
    filled: (
      <g>
        <g id="AlertCircleIcon/Fill/alert-circle">
          ...
          />
          <mask id="AlertCirclemask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="2" width="20" height="20">
            <path
    ...
    outline: (
      <g>
        <g id="AlertCircle-oIcon/Outline/alert-circle">
          ...
          />
          <mask id="AlertCircle-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="2" width="20" height="20">
            <path
