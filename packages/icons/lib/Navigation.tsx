    ...
    filled: (
      <g>
        <g id="NavigationIcon/Fill/navigation">
          ...
          />
          <mask id="Navigationmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="2" width="19" height="20">
            <path
              id="NavigationMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Navigation-oIcon/Outline/navigation">
          ...
          />
          <mask id="Navigation-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
