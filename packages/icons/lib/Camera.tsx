    ...
    filled: (
      <g>
        <g id="CameraIcon/Fill/camera">
          ...
          />
          <mask id="Cameramask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="CameraMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    outline: (
      <g>
        <g id="Camera-oIcon/Outline/camera">
          ...
          />
          <mask id="Camera-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="2" y="3" width="20" height="18">
            <path
              id="Camera-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
