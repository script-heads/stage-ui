...
export default React.forwardRef((props: Props, ref: React.ForwardedRef<HTMLSpanElement>) =>
  createIcon(props, ref, {
    filled: (
      <g>
        <g id="CalendarIcon/Fill/calendar">
          <path
            id="CalendarMask"
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          />
          <mask id="Calendarmask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="2" width="18" height="20">
            <path
              id="CalendarMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
          ...
          <g mask="url(#Calendarmask0)">
            <g id="Calendar&#Calendar240;&#Calendar159;&#Calendar142;&#Calendar168; Color">
              <rect id="CalendarBase" width="24" height="24" />
            </g>
          </g>
        </g>
      </g>
    ...
    outline: (
      <g>
        <g id="Calendar-oIcon/Outline/calendar">
          <path
            id="Calendar-oMask"
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          />
          <mask id="Calendar-omask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="3" y="2" width="18" height="20">
            <path
              id="Calendar-oMask_2"
              fillRule="evenodd"
              clipRule="evenodd"
          ...
          <g mask="url(#Calendar-omask0)">
            <g id="Calendar-o&#Calendar-o240;&#Calendar-o159;&#Calendar-o142;&#Calendar-o168; Color">
              <rect id="Calendar-oBase" width="24" height="24" />
            </g>
          </g>
        </g>
      </g>
