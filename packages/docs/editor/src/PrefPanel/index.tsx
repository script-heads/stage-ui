        ...
        <Block css={cs.scrollContainer}>
          ...
          {!!context.tools.focused && (
            <>
              <NameControls />
              <TextControls />
              {context.tools.focused.component === 'Flexbox' && <FlexControls />}
              <PaddingControls />
              <MarginControls />
              <SizeConrols />
              {literalProps.map((item, index) => (
                <LiteralControls key={index} name={item.name} values={item.values} />
              ))}
                ...
                <Block>
                  ...
                  <Block p="0.25rem">
                    {booleanProps.map((name, index) => (
                      <BooleanControls key={index} name={name} />
                    ))}
                  </Block>
                </Block>
              )}
              {stringProps.map((name, index) => (
                <StringControls key={index} name={name} />
              ))}
            </>
          )}
        </Block>
