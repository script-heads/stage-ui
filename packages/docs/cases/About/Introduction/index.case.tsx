...
import { Drop, Button, Popover, Flexbox } from '@flow-ui/core'
...
export default () => {
    ...
    return (
        <Flexbox w="600px" justifyContent="space-between">
            <Button ref={ref}>Trigger Popup</Button>
            <Drop target={ref} distance={8} align="top" justify="center">
                <div style={{background:'green'}}>111111111111111111</div>
            </Drop>
            <Button onClick={() => setv1(!v1)} ref={ref1}>Trigger Popup</Button>
            <Drop target={ref1} distance={8} align="right" justify="center" visibility={v1 ? 'visible' : 'hidden'} >
                <div style={{background:'red'}}>111111111111111111</div>
            </Drop>
            <Button onClick={() => setv2(!v2)} ref={ref2}>Trigger Popup</Button>
            <Drop target={ref2} distance={8} align="left" justify="center" visibility={v2 ? 'visible' : 'hidden'} >
            <div style={{background:'blue'}}>111111111111111111</div>
            </Drop>
        </Flexbox>
    )
}
