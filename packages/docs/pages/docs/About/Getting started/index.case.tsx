...
import { Block, Paragraph as P, Link, Text } from '@stage-ui/core'
...
export default () => (
    <Block>
        ...
        <P>Use <Text weight="bold" color="primary">Viewport</Text> component at the top level of your application.
