...
export default () => (
  <Block>
    <P>
      ...
      properties. Styles may also be necessary for each HTML element that is rendered in a DOM tree.
      Therefore, we have developed a special system based on emotion that takes these needs into
      account. There are two places you can do this: theme and the styles prop.
    </P>
    ...
    <P>
      ...
      state, the second is its value, the third style is assigned to the element in the case if the
      state takes this value. If state are boolean styles are described directly in the state name.
      All states are typed, so you can get hints from your IDE about values that you can override.
      If you develop in plain javascript or use simple text editor see this information in
      documentation.
    </P>
