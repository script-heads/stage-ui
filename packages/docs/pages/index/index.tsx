...
import { Badge, Block, Button, Flexbox, Popover, Spinner, TextField, Text, useTheme, Table, Meter, Radio, notify, dialog, Divider } from '@stage-ui/core'
        ...
        <Flexbox backgroundColor={c => c.surface} justifyContent="center">
            <Block
                ...
                <Components
                    ...
                    graphic={(
                        <Flexbox alignItems="center">
                            <Spinner size="2rem"/>
                            <Text ml="1rem" color="light">Spinner</Text>
                        </Flexbox>
                    )}
                ...
                <Components
                    ...
                    graphic={(
                        <Flexbox>
                            <Button mr="0.5rem" size="s" decoration="outline" onClick={() => dialog({ title: "Title", message: 'Message' })}>Dialog</Button>
                            <Button mr="0.5rem" size="s" decoration="outline" onClick={() => notify({ title: "Title", message: 'Message', timeout: 2000 })}>Notify</Button>
                        </Flexbox>
                    )}
