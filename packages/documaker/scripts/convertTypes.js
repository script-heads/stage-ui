...
let Types = {}
const doc = JSON.parse(fs.readFileSync(__dirname + '/../definitions/original.json', 'utf-8'));
...
fs.writeFileSync(__dirname + "/../definitions/types.json", JSON.stringify(Types, null, 4))
