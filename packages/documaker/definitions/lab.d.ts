...
declare module 'node_modules/@types/react' {
	...
	export = React;
	export as namespace React; namespace React {
	    //
	    // React Elements
	    // ----------------------------------------------------------------------
...
declare module 'layout/Split/types' {
	...
	import WhaleTypes from '@flow-ui/whale/types'; namespace SplitTypes {
	    interface Props extends Omit<WhaleTypes.AllProps<HTMLDivElement, Styles>, 'onMove' | 'onChange'> {
...
declare module 'layout/Split/styles' {
	...
	import Types from 'layout/Split/types'; const styles: WhaleTypes.CreateStyles<Types.Styles, Types.Props>;
...
declare module 'layout/Toolbar/styles' {
	import WhaleTypes from '@flow-ui/whale/types';
	import Types from 'layout/Toolbar/types'; const styles: WhaleTypes.CreateStyles<Types.Styles, Types.Props>;
	export default styles;
