...
const createAttributes = <Styles, Props extends SystemTypes.AllProps<unknown, Styles>>(
    props: Props,
    setFocus: React.Dispatch<React.SetStateAction<boolean>>,
    options: Options<Styles, Props>) => {

    const allProps = {
        attributes: {} as SystemTypes.AttributeProps,
        form: {} as Pick<Props, keyof SystemTypes.FormEventProps<unknown>>,
        focus: {} as Pick<Props, keyof SystemTypes.FocusEventProps<unknown>>,
        image: {} as Pick<Props, keyof SystemTypes.ImageEventProps<unknown>>,
        media: {} as Pick<Props, keyof SystemTypes.MediaEventProps<unknown>>,
        mouse: {} as Pick<Props, keyof SystemTypes.MouseEventProps<unknown>>,
        touch: {} as Pick<Props, keyof SystemTypes.TouchEventProps<unknown>>,
        wheel: {} as Pick<Props, keyof SystemTypes.WheelEventProps<unknown>>,
        pointer: {} as Pick<Props, keyof SystemTypes.PointerEventProps<unknown>>,
        keyboard: {} as Pick<Props, keyof SystemTypes.KeyboardEventProps<unknown>>,
        selection: {} as Pick<Props, keyof SystemTypes.SelectionEventProps<unknown>>,
        animation: {} as Pick<Props, keyof SystemTypes.AnimationEventProps<unknown>>,
        clipboard: {} as Pick<Props, keyof SystemTypes.ClipboardEventProps<unknown>>,
        transition: {} as Pick<Props, keyof SystemTypes.TransitionEventProps<unknown>>,
        composition: {} as Pick<Props, keyof SystemTypes.CompositionEventProps<unknown>>,
        scroll: {} as Pick<Props, keyof SystemTypes.ScrollEventProps<unknown>>,
