...
import SelectTypes from '../../core/control/Select/types'
...
const PlaygroundTable = () => {
  ...
  const pages = async () => {
    setLoading(true)
		const { data }: AxiosResponse<ResponsePassenger> = await axios({method: "GET", url: `${endPoint}/passenger`, params: {page: 0, size: pageSize[0].value} })
